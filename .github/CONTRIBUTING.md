...
### If you want to ask for feature or report bug
Just create a new issue in this github repo, if time allows us, someone will take a look.  
When creating a feature request or bug report do not write long essays, just something short and straight to the point. For bugs write where you encountered it. If in emulator, what emulator, and if on HW, how was the game run (ODE, CD, other way).

### If you want to contribute directly
Fork the repository, make your fix, and once you are happy with it, make PR to the main repo :)  
For the PR always write what has been changed, no need for it to be long, one sentece can do in 99% of the cases.

## How should the commit look if I want to contribute directly
follow the standard `fix`, `feat`, `docs` and add in between round brackets what area.  
example: `fix(CD): Fixed file reading`

## How should the code look if I want to contribute directly
