...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ACCUMULATE_OUTGOING_ARGS;
#else
  int x_TARGET_ACCUMULATE_OUTGOING_ARGS;
#define TARGET_ACCUMULATE_OUTGOING_ARGS global_options.x_TARGET_ACCUMULATE_OUTGOING_ARGS
#endif
#ifdef GENERATOR_FILE
extern const char *sh_atomic_model_str;
#else
  const char *x_sh_atomic_model_str;
#define sh_atomic_model_str global_options.x_sh_atomic_model_str
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_CBRANCH_FORCE_DELAY_SLOT;
#else
  int x_TARGET_CBRANCH_FORCE_DELAY_SLOT;
#define TARGET_CBRANCH_FORCE_DELAY_SLOT global_options.x_TARGET_CBRANCH_FORCE_DELAY_SLOT
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_FDPIC;
#else
  int x_TARGET_FDPIC;
#define TARGET_FDPIC global_options.x_TARGET_FDPIC
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_FSCA;
#else
  int x_TARGET_FSCA;
#define TARGET_FSCA global_options.x_TARGET_FSCA
#endif
#ifdef GENERATOR_FILE
extern int TARGET_FSRRA;
#else
  int x_TARGET_FSRRA;
#define TARGET_FSRRA global_options.x_TARGET_FSRRA
#endif
#ifdef GENERATOR_FILE
extern int TARGET_IEEE;
#else
  int x_TARGET_IEEE;
#define TARGET_IEEE global_options.x_TARGET_IEEE
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int sh_lra_flag;
#else
  int x_sh_lra_flag;
#define sh_lra_flag global_options.x_sh_lra_flag
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ENABLE_TAS;
#else
  int x_TARGET_ENABLE_TAS;
#define TARGET_ENABLE_TAS global_options.x_TARGET_ENABLE_TAS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_USERMODE;
#else
  int x_TARGET_USERMODE;
#define TARGET_USERMODE global_options.x_TARGET_USERMODE
#endif
#ifdef GENERATOR_FILE
extern int TARGET_ZDCBRANCH;
#else
  int x_TARGET_ZDCBRANCH;
#define TARGET_ZDCBRANCH global_options.x_TARGET_ZDCBRANCH
#endif
#ifdef GENERATOR_FILE
...
#define MASK_SH1 (1U << 0)
#define MASK_SH2 (1U << 1)
#define MASK_SH3 (1U << 2)
#define MASK_SH4 (1U << 3)
#define MASK_SH4A (1U << 4)
#define MASK_LITTLE_ENDIAN (1U << 5)
#define MASK_BIGTABLE (1U << 6)
#define MASK_BITOPS (1U << 7)
#define MASK_ALIGN_DOUBLE (1U << 8)
#define MASK_FMOVD (1U << 9)
#define MASK_HITACHI (1U << 10)
#define MASK_DUMPISIZE (1U << 11)
#define MASK_NOMACSAVE (1U << 12)
#define MASK_PADSTRUCT (1U << 13)
#define MASK_PREFERGOT (1U << 14)
#define MASK_RELAX (1U << 15)
#define MASK_FPU_SINGLE (1U << 16)
#define MASK_FPU_SINGLE_ONLY (1U << 17)
#define MASK_HARD_SH2A (1U << 18)
#define MASK_HARD_SH2A_DOUBLE (1U << 19)
#define MASK_HARD_SH4 (1U << 20)
#define MASK_SH_E (1U << 21)

/* SH1 mask */
#define TARGET_SH1 ((target_flags & MASK_SH1) != 0)
#define TARGET_SH1_P(target_flags) (((target_flags) & MASK_SH1) != 0)
#define TARGET_SH1_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH1) != 0)
#define TARGET_EXPLICIT_SH1_P(opts) ((opts->x_target_flags_explicit & MASK_SH1) != 0)
#define SET_TARGET_SH1(opts) opts->x_target_flags |= MASK_SH1
/* SH2 mask */
#define TARGET_SH2 ((target_flags & MASK_SH2) != 0)
#define TARGET_SH2_P(target_flags) (((target_flags) & MASK_SH2) != 0)
#define TARGET_SH2_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH2) != 0)
#define TARGET_EXPLICIT_SH2_P(opts) ((opts->x_target_flags_explicit & MASK_SH2) != 0)
#define SET_TARGET_SH2(opts) opts->x_target_flags |= MASK_SH2
/* SH3 mask */
#define TARGET_SH3 ((target_flags & MASK_SH3) != 0)
#define TARGET_SH3_P(target_flags) (((target_flags) & MASK_SH3) != 0)
#define TARGET_SH3_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH3) != 0)
#define TARGET_EXPLICIT_SH3_P(opts) ((opts->x_target_flags_explicit & MASK_SH3) != 0)
#define SET_TARGET_SH3(opts) opts->x_target_flags |= MASK_SH3
/* SH4 mask */
#define TARGET_SH4 ((target_flags & MASK_SH4) != 0)
#define TARGET_SH4_P(target_flags) (((target_flags) & MASK_SH4) != 0)
#define TARGET_SH4_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH4) != 0)
#define TARGET_EXPLICIT_SH4_P(opts) ((opts->x_target_flags_explicit & MASK_SH4) != 0)
#define SET_TARGET_SH4(opts) opts->x_target_flags |= MASK_SH4
/* SH4A mask */
#define TARGET_SH4A ((target_flags & MASK_SH4A) != 0)
#define TARGET_SH4A_P(target_flags) (((target_flags) & MASK_SH4A) != 0)
#define TARGET_SH4A_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH4A) != 0)
#define TARGET_EXPLICIT_SH4A_P(opts) ((opts->x_target_flags_explicit & MASK_SH4A) != 0)
#define SET_TARGET_SH4A(opts) opts->x_target_flags |= MASK_SH4A
/* LITTLE_ENDIAN mask */
...
#define TARGET_LITTLE_ENDIAN_OPTS_P(opts) (((opts->x_target_flags) & MASK_LITTLE_ENDIAN) != 0)
...
#define TARGET_BIGTABLE_P(target_flags) (((target_flags) & MASK_BIGTABLE) != 0)
#define TARGET_BIGTABLE_OPTS_P(opts) (((opts->x_target_flags) & MASK_BIGTABLE) != 0)
#define TARGET_EXPLICIT_BIGTABLE_P(opts) ((opts->x_target_flags_explicit & MASK_BIGTABLE) != 0)
#define SET_TARGET_BIGTABLE(opts) opts->x_target_flags |= MASK_BIGTABLE
/* BITOPS mask */
#define TARGET_BITOPS ((target_flags & MASK_BITOPS) != 0)
#define TARGET_BITOPS_P(target_flags) (((target_flags) & MASK_BITOPS) != 0)
#define TARGET_BITOPS_OPTS_P(opts) (((opts->x_target_flags) & MASK_BITOPS) != 0)
#define TARGET_EXPLICIT_BITOPS_P(opts) ((opts->x_target_flags_explicit & MASK_BITOPS) != 0)
#define SET_TARGET_BITOPS(opts) opts->x_target_flags |= MASK_BITOPS
/* ALIGN_DOUBLE mask */
...
#define TARGET_FMOVD_P(target_flags) (((target_flags) & MASK_FMOVD) != 0)
#define TARGET_FMOVD_OPTS_P(opts) (((opts->x_target_flags) & MASK_FMOVD) != 0)
#define TARGET_EXPLICIT_FMOVD_P(opts) ((opts->x_target_flags_explicit & MASK_FMOVD) != 0)
#define SET_TARGET_FMOVD(opts) opts->x_target_flags |= MASK_FMOVD
/* HITACHI mask */
#define TARGET_HITACHI ((target_flags & MASK_HITACHI) != 0)
#define TARGET_HITACHI_P(target_flags) (((target_flags) & MASK_HITACHI) != 0)
#define TARGET_HITACHI_OPTS_P(opts) (((opts->x_target_flags) & MASK_HITACHI) != 0)
#define TARGET_EXPLICIT_HITACHI_P(opts) ((opts->x_target_flags_explicit & MASK_HITACHI) != 0)
#define SET_TARGET_HITACHI(opts) opts->x_target_flags |= MASK_HITACHI
/* DUMPISIZE mask */
#define TARGET_DUMPISIZE ((target_flags & MASK_DUMPISIZE) != 0)
#define TARGET_DUMPISIZE_P(target_flags) (((target_flags) & MASK_DUMPISIZE) != 0)
#define TARGET_DUMPISIZE_OPTS_P(opts) (((opts->x_target_flags) & MASK_DUMPISIZE) != 0)
#define TARGET_EXPLICIT_DUMPISIZE_P(opts) ((opts->x_target_flags_explicit & MASK_DUMPISIZE) != 0)
#define SET_TARGET_DUMPISIZE(opts) opts->x_target_flags |= MASK_DUMPISIZE
/* NOMACSAVE mask */
#define TARGET_NOMACSAVE ((target_flags & MASK_NOMACSAVE) != 0)
#define TARGET_NOMACSAVE_P(target_flags) (((target_flags) & MASK_NOMACSAVE) != 0)
#define TARGET_NOMACSAVE_OPTS_P(opts) (((opts->x_target_flags) & MASK_NOMACSAVE) != 0)
#define TARGET_EXPLICIT_NOMACSAVE_P(opts) ((opts->x_target_flags_explicit & MASK_NOMACSAVE) != 0)
#define SET_TARGET_NOMACSAVE(opts) opts->x_target_flags |= MASK_NOMACSAVE
/* PADSTRUCT mask */
...
#define TARGET_PADSTRUCT_OPTS_P(opts) (((opts->x_target_flags) & MASK_PADSTRUCT) != 0)
#define TARGET_EXPLICIT_PADSTRUCT_P(opts) ((opts->x_target_flags_explicit & MASK_PADSTRUCT) != 0)
#define SET_TARGET_PADSTRUCT(opts) opts->x_target_flags |= MASK_PADSTRUCT
/* PREFERGOT mask */
#define TARGET_PREFERGOT ((target_flags & MASK_PREFERGOT) != 0)
#define TARGET_PREFERGOT_P(target_flags) (((target_flags) & MASK_PREFERGOT) != 0)
#define TARGET_PREFERGOT_OPTS_P(opts) (((opts->x_target_flags) & MASK_PREFERGOT) != 0)
#define TARGET_EXPLICIT_PREFERGOT_P(opts) ((opts->x_target_flags_explicit & MASK_PREFERGOT) != 0)
#define SET_TARGET_PREFERGOT(opts) opts->x_target_flags |= MASK_PREFERGOT
/* RELAX mask */
...
#define TARGET_FPU_SINGLE_P(target_flags) (((target_flags) & FPU_SINGLE) != 0)
#define TARGET_FPU_SINGLE_OPTS_P(opts) (((opts->x_target_flags) & MASK_FPU_SINGLE) != 0)
#define TARGET_FPU_SINGLE_ONLY ((target_flags & MASK_FPU_SINGLE_ONLY) != 0)
#define TARGET_FPU_SINGLE_ONLY_P(target_flags) (((target_flags) & FPU_SINGLE_ONLY) != 0)
#define TARGET_FPU_SINGLE_ONLY_OPTS_P(opts) (((opts->x_target_flags) & MASK_FPU_SINGLE_ONLY) != 0)
#define TARGET_HARD_SH2A ((target_flags & MASK_HARD_SH2A) != 0)
#define TARGET_HARD_SH2A_P(target_flags) (((target_flags) & HARD_SH2A) != 0)
#define TARGET_HARD_SH2A_OPTS_P(opts) (((opts->x_target_flags) & MASK_HARD_SH2A) != 0)
#define TARGET_HARD_SH2A_DOUBLE ((target_flags & MASK_HARD_SH2A_DOUBLE) != 0)
#define TARGET_HARD_SH2A_DOUBLE_P(target_flags) (((target_flags) & HARD_SH2A_DOUBLE) != 0)
#define TARGET_HARD_SH2A_DOUBLE_OPTS_P(opts) (((opts->x_target_flags) & MASK_HARD_SH2A_DOUBLE) != 0)
#define TARGET_HARD_SH4 ((target_flags & MASK_HARD_SH4) != 0)
#define TARGET_HARD_SH4_P(target_flags) (((target_flags) & HARD_SH4) != 0)
#define TARGET_HARD_SH4_OPTS_P(opts) (((opts->x_target_flags) & MASK_HARD_SH4) != 0)
#define TARGET_SH_E ((target_flags & MASK_SH_E) != 0)
#define TARGET_SH_E_P(target_flags) (((target_flags) & SH_E) != 0)
#define TARGET_SH_E_OPTS_P(opts) (((opts->x_target_flags) & MASK_SH_E) != 0)
...
enum opt_code
{
  ...
  OPT_m2 = 1956,                             /* -m2 */
  OPT_m2a = 1957,                            /* -m2a */
  OPT_m2a_nofpu = 1958,                      /* -m2a-nofpu */
  OPT_m2a_single = 1959,                     /* -m2a-single */
  OPT_m2a_single_only = 1960,                /* -m2a-single-only */
  OPT_m2e = 1961,                            /* -m2e */
  OPT_m3 = 1962,                             /* -m3 */
  OPT_m3e = 1963,                            /* -m3e */
  OPT_m4 = 1964,                             /* -m4 */
  OPT_m4_100 = 1965,                         /* -m4-100 */
  OPT_m4_100_nofpu = 1966,                   /* -m4-100-nofpu */
  OPT_m4_100_single = 1967,                  /* -m4-100-single */
  OPT_m4_100_single_only = 1968,             /* -m4-100-single-only */
  OPT_m4_200 = 1969,                         /* -m4-200 */
  OPT_m4_200_nofpu = 1970,                   /* -m4-200-nofpu */
  OPT_m4_200_single = 1971,                  /* -m4-200-single */
  OPT_m4_200_single_only = 1972,             /* -m4-200-single-only */
  OPT_m4_300 = 1973,                         /* -m4-300 */
  OPT_m4_300_nofpu = 1974,                   /* -m4-300-nofpu */
  OPT_m4_300_single = 1975,                  /* -m4-300-single */
  OPT_m4_300_single_only = 1976,             /* -m4-300-single-only */
  OPT_m4_340 = 1977,                         /* -m4-340 */
  OPT_m4_400 = 1978,                         /* -m4-400 */
  OPT_m4_500 = 1979,                         /* -m4-500 */
  OPT_m4_nofpu = 1980,                       /* -m4-nofpu */
  OPT_m4_single = 1981,                      /* -m4-single */
  OPT_m4_single_only = 1982,                 /* -m4-single-only */
  OPT_m4a = 1983,                            /* -m4a */
  OPT_m4a_nofpu = 1984,                      /* -m4a-nofpu */
  OPT_m4a_single = 1985,                     /* -m4a-single */
  OPT_m4a_single_only = 1986,                /* -m4a-single-only */
  OPT_m4al = 1987,                           /* -m4al */
  OPT_maccumulate_outgoing_args = 1988,      /* -maccumulate-outgoing-args */
  OPT_matomic_model_ = 1989,                 /* -matomic-model= */
  OPT_mb = 1990,                             /* -mb */
  OPT_mbigtable = 1991,                      /* -mbigtable */
  OPT_mbitops = 1992,                        /* -mbitops */
  OPT_mbranch_cost_ = 1993,                  /* -mbranch-cost= */
  OPT_mcbranch_force_delay_slot = 1994,      /* -mcbranch-force-delay-slot */
  OPT_mdalign = 1995,                        /* -mdalign */
  OPT_mdiv_ = 1996,                          /* -mdiv= */
  OPT_mdivsi3_libfunc_ = 1997,               /* -mdivsi3_libfunc= */
  OPT_mfdpic = 1998,                         /* -mfdpic */
  OPT_mfixed_range_ = 1999,                  /* -mfixed-range= */
  OPT_mfmovd = 2000,                         /* -mfmovd */
  OPT_mfsca = 2001,                          /* -mfsca */
  OPT_mfsrra = 2002,                         /* -mfsrra */
  /* OPT_mfused_madd = 2003, */              /* -mfused-madd */
  OPT_mhitachi = 2004,                       /* -mhitachi */
  OPT_mieee = 2005,                          /* -mieee */
  OPT_minline_ic_invalidate = 2006,          /* -minline-ic_invalidate */
  OPT_misize = 2007,                         /* -misize */
  OPT_ml = 2008,                             /* -ml */
  OPT_mlra = 2009,                           /* -mlra */
  OPT_mnomacsave = 2010,                     /* -mnomacsave */
  OPT_mpadstruct = 2011,                     /* -mpadstruct */
  OPT_mprefergot = 2012,                     /* -mprefergot */
  OPT_mpretend_cmove = 2013,                 /* -mpretend-cmove */
  OPT_mrelax = 2014,                         /* -mrelax */
  OPT_mrenesas = 2015,                       /* -mrenesas */
  OPT_mtas = 2016,                           /* -mtas */
  OPT_multcost_ = 2017,                      /* -multcost= */
  OPT_musermode = 2018,                      /* -musermode */
  OPT_mzdcbranch = 2019,                     /* -mzdcbranch */
  OPT_n = 2020,                              /* -n */
  OPT_name_sort = 2021,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2022,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2023,              /* -no-integrated-cpp */
  OPT_no_pie = 2024,                         /* -no-pie */
  OPT_nocpp = 2025,                          /* -nocpp */
  OPT_nodefaultlibs = 2026,                  /* -nodefaultlibs */
  OPT_nolibc = 2027,                         /* -nolibc */
  OPT_nophoboslib = 2028,                    /* -nophoboslib */
  OPT_nostartfiles = 2029,                   /* -nostartfiles */
  OPT_nostdinc = 2030,                       /* -nostdinc */
  OPT_nostdinc__ = 2031,                     /* -nostdinc++ */
  OPT_nostdlib = 2032,                       /* -nostdlib */
  OPT_nostdlib__ = 2033,                     /* -nostdlib++ */
  OPT_o = 2034,                              /* -o */
  OPT_objects = 2035,                        /* -objects */
  OPT_p = 2036,                              /* -p */
  OPT_pass_exit_codes = 2037,                /* -pass-exit-codes */
  /* OPT_pedantic = 2038, */                 /* -pedantic */
  OPT_pedantic_errors = 2039,                /* -pedantic-errors */
  OPT_pg = 2040,                             /* -pg */
  OPT_pie = 2041,                            /* -pie */
  OPT_pipe = 2042,                           /* -pipe */
  OPT_print_file_name_ = 2043,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2044,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2045,          /* -print-multi-directory */
  OPT_print_multi_lib = 2046,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2047,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2048,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2049,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2050,               /* -print-prog-name= */
  OPT_print_search_dirs = 2051,              /* -print-search-dirs */
  OPT_print_sysroot = 2052,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2053,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2054,                    /* -print-value */
  OPT_quiet = 2055,                          /* -quiet */
  OPT_r = 2056,                              /* -r */
  ...
  OPT_time = 2152,                           /* -time */
  OPT_time_ = 2153,                          /* -time= */
  OPT_traditional = 2154,                    /* -traditional */
  OPT_traditional_cpp = 2155,                /* -traditional-cpp */
  OPT_tree_stats = 2156,                     /* -tree-stats */
  OPT_trigraphs = 2157,                      /* -trigraphs */
  OPT_type_stats = 2158,                     /* -type-stats */
  OPT_u = 2159,                              /* -u */
  OPT_undef = 2160,                          /* -undef */
  OPT_v = 2161,                              /* -v */
  OPT_version = 2162,                        /* -version */
  OPT_w = 2163,                              /* -w */
  OPT_wrapper = 2164,                        /* -wrapper */
  OPT_x = 2165,                              /* -x */
  OPT_z = 2166,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
