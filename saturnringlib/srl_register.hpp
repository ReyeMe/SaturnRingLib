...
namespace SRL
{
    ...
    {
        /**
         * @brief Access mode for memory regions on the devcart.
         */
        ...
        /**
         * @brief Simple POD describing a memory region on the devcart.
         *
        ...
        struct Register
        {
            ...
            const uintptr_t address; ///< Base address of the region
            const size_t size;       ///< Size of the region in bytes
